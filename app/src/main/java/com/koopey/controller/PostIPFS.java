 ...
 */
public class PostIPFS extends AsyncTask<String, String, String> {

    private static final String LOG_HEADER = "PostIPFS";
    public PostIPFS.PostResponseListener delegate = null;
    ...
    public PostIPFS(Context context) { this.context = context; }
